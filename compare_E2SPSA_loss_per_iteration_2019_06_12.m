% late updated: 2019_06_12
% compare SL_E2SP, FA_E2SP
...
a = 0.3; A = 50; c = 0.05; c_tilde = c; d = 0.501;
...
for algo_idx = [3,4] % SL_2SP, FA_2SP, SL_E2SP, FA_E2SP
    rng(seed);
...
save('compare_E2SPSA_loss_per_iteration_2019_06_12');
...
xticklabels({'0','2000','4000','8000','10000'})

% legend({'Original 2SPSA','Efficient 2SPSA'},'FontSize',13)
legend({'Original E2SPSA','Efficient E2SPSA'},'FontSize',13)
hold off
...
print(fig,'compare_E2SPSA_loss_per_iteration_2019_06_12','-dpdf');